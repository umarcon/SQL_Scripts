...
ALTER PROCEDURE [Starsoft].[Reports_252_CO]
...
-- Armazeno os lançamentos Contábeis na Conta de Clientes 1102010001
	SELECT * 
	INTO #TMP_RAZAO
	FROM [Starsoft].[fnReports_252_CO](@initial_date,@final_date)
			...
			FROM
				...
				INNER JOIN (	
								...
								FROM
									...
									INNER JOIN StarWestconCala2.dbo.J11 J11_DEV (NOLOCK) ON J11_DEV.J10_UKEY = J10_DEV.UKEY AND J10_DEV.CIA_UKEY IN ('M8531','M8530')
...
-- *******************************   QUERY DE NOTAS DE DEVOLUCAO DE VENDAS - FIM ****************************************	
	...
	WHERE 
		F18.CIA_UKEY IN ('M8531','M8530') AND
	...
	FROM
		...
		JOIN StarWestconCala2.dbo.CIA CIA (NOLOCK) ON F12.CIA_UKEY = CIA.UKEY
	WHERE
		F12.CIA_UKEY IN ('M8531','M8530') AND
