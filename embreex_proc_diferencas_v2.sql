...
GO
ALTER PROC [dbo].[GtiDifencasEstoque_v2]
(
@DATA DATETIME,
@DATAINI DATETIME
...
INSERT INTO TMP_MOV
SELECT D04_UKEY,D07_UKEY FROM D14 WHERE D14_999_C IN ('001','005') AND D14_001_T BETWEEN @DATA+' 00:00' AND @DATA+' 23:59' GROUP BY D04_UKEY,D07_UKEY
UNION ALL
SELECT D04_UKEY,D07_UKEY FROM D22 WHERE D22_999_C IN ('002','005') AND D22_001_T BETWEEN @DATA+' 00:00' AND @DATA+' 23:59' GROUP BY D04_UKEY,D07_UKEY
