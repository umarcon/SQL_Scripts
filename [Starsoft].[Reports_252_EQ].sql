...
ALTER PROCEDURE [Starsoft].[Reports_252_EQ]
...
-- Armazeno os lançamentos Contábeis na Conta de Clientes 1102010001
	SELECT * 
	INTO #TMP_RAZAO
	FROM [Starsoft].[fnReports_252_EQ](@initial_date,@final_date)
			...
			FROM
				...
				INNER JOIN (	
								...
								FROM
									...
									INNER JOIN StarWestconCala2.dbo.J11 J11_DEV (NOLOCK) ON J11_DEV.J10_UKEY = J10_DEV.UKEY AND J10_DEV.CIA_UKEY = '5HV8Z'
